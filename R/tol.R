...
##'     used to build it.
##'
##' @param include_source_list Whether to return the information on the
##'     trees and studies that contribute to the synthetic tree
...
##' \code{tol_about(include_source_list = TRUE)} and returns a data frame
...
##' @param tol an object created using \code{tol_about(include_source_list = TRUE)}
##' @return a data frame
##' @export
