...
concerning. `BARREN` means these taxa have no descendants and `MAJOR_RANK_CONFLICT`
refers to inconsitancies between the rank of these taxa and some of their
relatives. For thtese reasons,t _Meleagris_ and _Anas_ are not included in
the synthetic tree.
